...
//COUNT WEAPONRY AND ADD TO POOL
...
if(_heli hasweapon "fza_ma_safe") then
{
_masafeqty = _masafeqty + (_heli ammo "fza_ma_safe");
};
...
{_heli removeweapon _x;} foreach (weapons _heli - ["fza_ma_safe","fza_m230"]);
