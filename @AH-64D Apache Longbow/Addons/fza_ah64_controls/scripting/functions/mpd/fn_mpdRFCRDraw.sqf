...
if (_heli getVariable "fza_ah64_agmode" == 1) then {
	[_heli, _targetsToDraw, false, 0.000125 * 0.3, [0.5, 0.5]] call fza_fnc_mpdUpdatePoints;
} else {
	[_heli, _targetsToDraw, false, 0.000125 * 0.3, [0.5, 0.2]] call fza_fnc_mpdUpdatePoints;
}